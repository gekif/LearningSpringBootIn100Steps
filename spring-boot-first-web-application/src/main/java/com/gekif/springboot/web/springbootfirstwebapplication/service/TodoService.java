...
public class TodoService {
    ...
    static {
        todos.add(new Todo(1, "gekif", "Learn Spring MVC", new Date(),
                false));
        todos.add(new Todo(2, "gekif", "Learn Struts", new Date(), false));
        todos.add(new Todo(3, "gekif", "Learn Hibernate", new Date(),
                false));
    }
